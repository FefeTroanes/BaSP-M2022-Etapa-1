...
var fiveWordArray = ['Como', 'me', 'gusta', 'la', 'tarta'];
for (var i = 0; i < 5; i++) {
    alert(fiveWordArray[i]);
}
...
for (var i = 0; i < 5; i++) {
    alert(fiveWordArray[i][0].toUpperCase() + fiveWordArray[i].substring(1).toLowerCase());
}
